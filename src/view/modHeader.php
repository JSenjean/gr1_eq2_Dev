...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[PHP_SELF]" ?>">Alors la scrum ?</a>
                ...
                <li>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            <h6 class="dropdown-header"><?php $_SESSION['role']=="admin" ? print 'Administrateur' : print "Modérateur"?></h6>
